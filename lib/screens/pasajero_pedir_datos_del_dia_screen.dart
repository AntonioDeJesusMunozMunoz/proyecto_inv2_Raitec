...
// Pantalla principal
class PasajeroPedirDatosScreen extends StatelessWidget {
  const PasajeroPedirDatosScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text('Pasajeros Max:', style: smallTestFont),
                const SizedBox(width: 8),
                SizedBox(
                  width: 150,
                  height: 70,
            ...
            Text('Ruta:', style: testFont,),

            GestureDetector(
              onTap: () => {ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('esto mostrará la pantalla de añadir ruta'),
